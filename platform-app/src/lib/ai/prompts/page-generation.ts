...
export function buildPageGenerationPrompt(
  ...
  sections.push(
    ...
    ``,
    `### Hero Headline Quality (CRITICAL)`,
    `- NEVER use generic headlines like "Welcome", "Welcome to [Business Name]", or "Home"`,
    `- The hero h1 MUST be a compelling, marketing-grade headline that communicates the core value proposition`,
    `- Include the primary SEO keyword naturally in the hero title`,
    `- Target 5-12 words — punchy, benefit-driven, audience-aware`,
    `- Good examples: "Expert Family Dental Care — Smiles That Last a Lifetime", "Portland's Trusted Home Renovation Specialists"`,
    `- Bad examples: "Welcome to Smith Dental", "Welcome", "About Our Company", "Home Page"`,
    `- The hero sub_headline should expand on the h1 with a supporting benefit or call to action`,
    ``,
    `### Icon Validation`,
