  ...
  return (
    <div className="flex flex-col gap-1.5 text-left">
      ...
      <select
        ...
        className="rounded-xl bg-white/10 px-4 py-3 text-white border border-white/10 focus:border-brand-500 focus:outline-none appearance-none cursor-pointer truncate"
