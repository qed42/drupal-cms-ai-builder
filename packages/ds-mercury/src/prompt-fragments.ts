...
export function buildPromptDesignGuidance(): string {
  return [
    ...
    "- **Mercury Hero Billboard**: `media` (not `background_image`), `height`, `flex_position`, `overlay_opacity` (string: \"0%\"|\"20%\"|\"40%\"|\"60%\"|\"75%\"). MUST have hero_slot filled with a heading (level 1, text_color inverted, text_size heading-responsive-5xl). Set overlay_opacity to at least \"40%\" for text readability.",
